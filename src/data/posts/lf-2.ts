...
export const LF2_POSTS: PostArticle[] = [
  ...
  },
  {
    ...
    "elements": [
      ...
      {
        "type": "SUBTITLE",
        "content": "Modernes Management - Lean Management, Lean Production"
      },
      {
        "type": "TEXT",
        "content": "Schlankes Management und schlanke Produktion entstehen durch den Einsatz von möglichst wenig Ressourcen (Mitarbeiter, Maschinen, schnelle Abläufe). Straffung des Managements durch möglichst wenige Hierarchiestufen im Management und Stärkung der Eigenverantwortung jedes Mitarbeiters."
      }
    ]
  },
  {
