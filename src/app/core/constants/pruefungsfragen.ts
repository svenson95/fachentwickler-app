...
export const auditQuestions: AuditQuestion[] = [
  ...
  {
    question:
      'In welcher der folgenden Marktformen ist die Einflussnahme auf den Preis seitens des Händlers am höchsten?',
    choices: ['Monopol', 'Oligopol', 'Monopson', 'Polypol', 'Oligopson'],
    answer: 1,
  },
  {
